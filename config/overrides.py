...
FIELDS: tuple[Field, ...] = (
    ...
    Field("session_filter_enabled", "protect", "Trade only in session",
          "Weekdays in the hours below (UTC)."),
    Field("session_start_utc", "protect", "Session start (UTC hour)", "", kind="int",
          lo=0, hi=23),
    Field("session_end_utc", "protect", "Session end (UTC hour)", "", kind="int", lo=1, hi=24),
    ...
    Field("v2_backtest_enabled", "v2", "Daily v2 backtest",
          "02:17 UTC, in a separate process."),
